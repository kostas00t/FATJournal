	...
	int silent, struct fat_bios_param_block *bpb)
{
	...
	printk(KERN_INFO "--------------------------------------------");
	printk(KERN_INFO "Inside fat_read_bpb of inode.c");
	printk(KERN_INFO "Number of FATs: %d\n", bpb->fat_fats);
	printk(KERN_INFO "Fat Sector Size: %d\n", bpb->fat_fat_length);
	printk(KERN_INFO "Number of Sectors: %d\n", bpb->fat_total_sect);
	printk(KERN_INFO "Superblock s_count: %d\n", sb->s_count);
	printk(KERN_INFO "Superblock s_blocksize: %d\n", sb->s_blocksize);
	printk(KERN_INFO "Superblock s_max_links: %ld\n", sb->s_max_links);
	printk(KERN_INFO "Superblock s_stack_depth: %ld\n", sb->s_stack_depth);
	printk(KERN_INFO "--------------------------------------------");

	printk(KERN_INFO "Trying to open filejournal created from boot");
	int filejournal = sys_open("/tmp/filejournal", O_RDWR, 0);
	printk(KERN_INFO "filejournal int value: %d\n", filejournal);
	sys_write(filejournal, "Test writing to filejournal\n", strlen("Test writing to filejournal\n"));
		   ...
		   void (*setup)(struct super_block *))
{
	...
	printk(KERN_INFO "-------------------------------------------------");
	printk(KERN_INFO "Inside fat_fill_super of inode.c");
	printk(KERN_INFO "Sectors per cluster: %d\n", sbi->sec_per_clus);
	printk(KERN_INFO "Cluster size: %d\n", sbi->cluster_size);
	printk(KERN_INFO "Directories per block: %d\n", sbi->dir_per_block);
	printk(KERN_INFO "Free_clusters: %d\n", sbi->free_clusters);
	printk(KERN_INFO "FAT starts at: %d\n", sbi->fat_start);
	printk(KERN_INFO "FAT length: %ld\n", sbi->fat_length);
	printk(KERN_INFO "FAT s_maxbytes (maximum file size): %lld\n", sb->s_maxbytes);
	printk(KERN_INFO "-------------------------------------------------");
